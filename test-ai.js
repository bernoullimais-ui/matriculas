...
const systemInstruction = `A função recebe um objeto 'context' com as seguintes propriedades:
...
async function run() {
  const response = await ai.models.generateContent({
    ...
    contents: "Alunos com matriculas ativas na unidade Escola Pequeno Liceu",
